...
class _PlansPageState extends State<PlansPage> with TickerProviderStateMixin {
  ...
  // --- 🆕 GESTURE VARIABLES (ROTATION SETUP) ---
    ...
    if (_selectedIndex != index) {
      _imageController.reverse().then((_) {
        setState(() {
          ...
          // Reset transformation on image change
          _scale = 1.0;
          _rotation = 0.0;
          _offset = Offset.zero;
        });
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            ...
            children: [
              ...
              // IMAGE VIEWER SECTION (UPDATED FOR ROTATION)
              Expanded(
                child: Stack(
                  children: [
                    // Background Texture
                    ...
                    FadeTransition(
                      ...
                      child: FadeTransition(
                        ...
                        child: GestureDetector(
                          ...
                          behavior: HitTestBehavior.translucent, // Catches touches outside image
                          child: Container(
                            ...
                            child: Center(
                              child: Transform(
                                ...
                                transform: Matrix4.identity()
                                  ..translate(_offset.dx, _offset.dy) // Move
                                  ..rotateZ(_rotation)                // Rotate
                                  ..scale(_scale),                    // Zoom
                                child: Hero(
                                  tag: 'plan_${menuTitles[_selectedIndex]}',
                                  child: Container(
                                    // Removed fixed margin to allow full movement
                                    decoration: BoxDecoration(
                                      color: Colors.white,
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.asset(
                                        ...
                                        fit: BoxFit.contain, // Allow size to adjust naturally
...
// --------------------------------------------------------------------------
// 1. SCALLOPED MENU BUTTON (Exact "Explore" Replica)
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// 2. THE CUSTOM PAINTER (The "3-Bump" Scallop Shape)
// --------------------------------------------------------------------------
