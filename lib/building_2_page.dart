...
class Building2Page extends StatefulWidget {
  const Building2Page({Key? key}) : super(key: key);

  @override
  State<Building2Page> createState() => _Building2PageState();
}

class _Building2PageState extends State<Building2Page> with TickerProviderStateMixin {
  static const _prefsKeyMenuRight = 'building_2_menu_right_aligned';
  ...
  final List<String> imagePaths = [
    "assets/buildingtwo/A-4 FLOOR PLAN-V1_C2C-TYPICAL FLOUR PLAN_BUILDING 2.pdf.png",
    "assets/buildingtwo/A-4 FLOOR PLAN-V1_C2C-3BHK GRAND_BUILDING 2.pdf.png",
    "assets/buildingtwo/A-4 FLOOR PLAN-V1_C2C-1BHK-B.pdf.png",
    "assets/buildingtwo/A-4 FLOOR PLAN-V1_C2C-2BHK-B.pdf.png",
    "assets/buildingtwo/A-4 FLOOR PLAN-V1_C2C-2BHK-C.pdf.png",
    "assets/buildingtwo/A-4 FLOOR PLAN-V1_C2C- REFUGE FLOUR PLAN_BUILDING 2.pdf.png",
  ];
  ...
  Future<void> _loadMenuAlignment() async {
    ...
    setState(() {
      ...
      _isCompareMode = prefs.getBool('building_2_compare_mode') ?? true;
    });
  }
  ...
  Future<void> _saveMenuAlignment() async {
    ...
    await prefs.setBool('building_2_compare_mode', _isCompareMode);
  }
        ...
        child: Stack(
          children: [
            const Positioned(
              left: -50,
              bottom: -50,
              child: ExperienceAura(color: Color(0xFFFFCC80)),
            ),
...
class ExperienceMenuButton extends StatelessWidget {
  final String title;
  final bool isSelected;
  final VoidCallback onTap;
  const ExperienceMenuButton({Key? key, required this.title, required this.isSelected, required this.onTap}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            gradient: isSelected 
              ? const LinearGradient(colors: [Color(0xFFE65100), Color(0xFFFF9100)])
              : null,
