...
class _HeroPageState extends State<HeroPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _sunRotationController = AnimationController(
      vsync: this,
      duration: const Duration(seconds: 10), // Slow continuous rotation
    )..repeat();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /// 3 & 4. Consolidated Logos (Nature Vista & Oyster)
AnimatedPositioned(
  ...
  child: AnimatedOpacity(
    ...
    child: FadeTransition(
      ...
      child: Column(
        crossAxisAlignment: _isRightAligned
            ? CrossAxisAlignment.start
            : CrossAxisAlignment.end,
        children: [

          // ✅ Second Logo (NOW ON TOP) with WHITE background
          Container(
            width: 220,
          ...
          // ✅ First Logo (NOW BELOW)
          SizedBox(
            width: 220,
            child: Image.asset(
              'assets/images/Oyster Group Horizontal Logo.jpg',
              fit: BoxFit.contain,
            ),
          ),
        ],
