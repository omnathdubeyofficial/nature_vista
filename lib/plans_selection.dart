...
class PlansSelectionPage extends StatefulWidget {
  const PlansSelectionPage({Key? key}) : super(key: key);

  @override
  State<PlansSelectionPage> createState() => _PlansSelectionPageState();
}

class _PlansSelectionPageState extends State<PlansSelectionPage> with TickerProviderStateMixin {
          ...
          children: [
            ...
            Positioned.fill(
              child: Container(
                color: Colors.white,
                child: Image.asset(
                  'assets/newback/plansbackgraund.png',
                  fit: BoxFit.contain,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          _planButton("MASTER LAYOUT", Icons.layers_outlined, () => Navigator.pushNamed(context, '/master_layout')),
                          const SizedBox(height: 20),
                          _planButton("SECTOR LAYOUT", Icons.map_outlined, () => Navigator.pushNamed(context, '/sector_layout')),
                          const SizedBox(height: 20),
                          _planButton("BUILDING 1 PLANS", Icons.apartment_rounded, () => Navigator.pushNamed(context, '/building_1')),
                          const SizedBox(height: 20),
                          _planButton("BUILDING 2 PLANS", Icons.apartment_rounded, () => Navigator.pushNamed(context, '/building_2')),
  ...
  Widget _animatedPositionedControl({required int index, required Widget child}) {
    // This is no longer used but kept for internal references if any
    return Positioned(child: child);
  }

  Widget _planButton(String label, IconData icon, VoidCallback onTap) {
