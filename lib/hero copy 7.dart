                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildSunButton(Icons.map_rounded, 'Plans',
                          () => Navigator.pushNamed(context, '/plans'), 2),
                      const SizedBox(height: 0),
                        buildSunButton(Icons.menu_book_rounded, 'flipbook',
                          () => Navigator.pushNamed(context, '/flipbook'), 2),
                      const SizedBox(height: 0),
                      buildSunButton(Icons.photo_library_rounded, 'Gallery',
                          () => Navigator.pushNamed(context, '/gallery'), 3),
                      const SizedBox(height: 0),
                      buildSunButton(Icons.videocam_rounded, 'TOUR',
                          () => Navigator.pushNamed(context, '/walkthrough'), 4),
                      const SizedBox(height: 0),
                      buildSunButton(Icons.spa_rounded, 'Amenities',
                          () => Navigator.pushNamed(context, '/amenities'), 5),
                      const SizedBox(height: 0),
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        return Transform.rotate(
                          ...
                          child: const RealSunRaysPainter(
                            width: 140,
                            height: 140,
                          ),
                        );
